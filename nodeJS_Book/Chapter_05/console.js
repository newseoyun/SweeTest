/*
console엔 log, error, info 등등 많이 있음. 문서 참고(https://nodejs.org/api/console.html)
*/
...
console.log("\033[36m" + new Date() + "\033[0m"); // \033[ 이건 \e[(알파벳 e) 혹은 \0x1B[(16진수) 이거랑 같다(이스케이프 및 ANSI코드의 시작을 의미함). 36m은 청록색. \033[0m 이건 초기화 의미.
